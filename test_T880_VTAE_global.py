...
# This code demonstrates how Algorithm 1 works to solve for a relaxed version of VTAE with global disjointness
from gurobipy import *
import numpy as np
import sys
import descriptor_discover
import divide_label_universe_smart_global	
...
m = divide_label_universe_smart_global.luo_min_fl(UEls, Ng, T)
luo_step1_time = m.runTime
cons_fl = m.objVal
m = divide_label_universe_smart_global.luo_min_influence_cons_fl(IEls, UEls, Ng, T, cons_fl)
...
np.savez('VTAE_global_T880.npz',data=mydata)
